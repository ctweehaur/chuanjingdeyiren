/**
 * 互动古文教学平台 - 简答题特训专属题库 (数据纯净化 · 完美对齐版)
 */
...
const shortQData = [
    {
        ...
        sPy: [
            "dì yī bù dīng shì yuán huà chuān jǐng dé yī rén zài wén zhōng duì yìng nǎ jù jiě shī",
            "dì èr bù dé yī rén zài gǔ dài hàn yǔ zhōng yǒu nǎ liǎng zhǒng kě ng de lǐ jiě",
        ...
        aPy: "dīng shì yuán yì  duō dé dào yí gè láo dòng lì ér dé yī rén zì miàn shàng kě lǐ jiě wéi huò dé yí gè rén shí tǐ tīng zhě méi y jǐ hé shàng xià wén chuán bō shí shī shí dǎo zhì wù jiě",
    ...
    },
    {
        ...
        sPy: [
            ...
            "dì sān bù zhè jù huà wèi xià wwen zuò le nǎ xiē pū diàn"
        ],
    ...
    },
    {
        ...
        // 彻底净化：没有任何硬编码多余空格，实现自然流畅的精美拼音汉字咬合
