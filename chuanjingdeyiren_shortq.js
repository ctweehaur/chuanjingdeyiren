/**
 * 互动古文教学平台 - 简答题特训专属题库 (Q1 - Q5 终极精炼版)
 * 适用标准：新加坡、马来西亚中学华文 pedagogy / EdTech 课程整合
 */
...
const shortQData = [
    {
        ...
        sZh: "第一步：丁氏原话“穿井得一人”在文中对应哪句解释？\n第二步：“得一人”在古代汉语中有哪两种可能的理解？\n第三步：传播者犯了什么错误？",
        sPy: "dì yī bù dīng shì yuán huà chuān jǐng dé yī rén zài wén zhōng duì yìng nǎ jù jiě shì\ndì èr bù dé yī rén zài gǔ dài hàn yǔ zhōng yǒu nǎ liǎng zhǒng kě néng de lǐ jiě\ndì sān bù chuán bō zhě fàn le shén me cuò wù",
        sEn: "Step 1: Which explanation in the text corresponds to Ding's original words?\nStep 2: What are the two possible interpretations of 'gained one person' in classical Chinese?\nStep 3: What mistake did the transmitters make?",
    ...
    },
    {
        ...
        sZh: "第一步：“国人道之”说明谣言传播的广度如何？\n第二步：“闻之于宋君”说明谣言影响到了哪个层面？\n第三步：这句话为下文做了哪些铺垫？",
        sPy: "dì yī bù guó rén dào zhī shuō míng yáo yán chuán bō de guǎng dù rú hé\ndì èr bù wén zhī yú sòng jūn shuō míng yáo yán yǐng xiǎng dào le nǎ gè céng miàn\ndì sān bù zhè jù huà wèi xià wén zuò le nǎ xiē pū diàn",
        sEn: "Step 1: What does 'the people talked about it' show about the breadth of the rumor's spread?\nStep 2: What level of impact does 'reached the Lord of Song' indicate?\nStep 3: What kind of foreshadowing does this sentence provide for the following text?",
    ...
    },
    {
        ...
        sZh: "第一步：如果得到的是失真消息，会有什么后果？\n第二步：与“没有任何消息”相比，虚假消息的危害哪个更大？\n第三步：作者借此告诫人们对待传闻应采取什么态度？",
        sPy: "dì yī bù rú guǒ dé dào de shì shī zhēn xiāo xī huì yǒu shén me hòu guǒ\ndì èr bù yǔ méi yǒu rèn hé xiāo xī xiāng bǐ xū jiǎ xiāo xī de wēi hài nǎ gè gèng dà\ndì sān bù zuò zhě jiè cǐ gào jiè rén men duì dài chuán wén yīng cǎi qǔ shén me tài dù",
        sEn: "Step 1: What are the consequences of obtaining distorted information?\nStep 2: Compared to 'having no information,' which poses a greater harm—false information or none?\nStep 3: What attitude towards rumors does the author warn people to adopt?",
    ...
    },
    {
        ...
        sPy: "dì yī bù chuán bō zhě méi yǒu qù hé shí yuán huà\ndì èr bù yáo yán chǎn shēng de yuán yīn yǒu nǎ xiē\ndì sān bù zuò wéi xiàn dài rén miàn duì wǎng lù xìn xī yīng gāi zěn me zuò",
        sEn: "Step 1: Did the transmitters verify the original statement?\nStep 2: What are the primary causes behind the creation of rumors?\nStep 3: As a modern citizen, how should one handle information on the internet?",
    ...
    },
    {
        ...
        sPy: "dì yī bù qǐ diǎn dīng shì shuō le shén me yuán huà\ndì èr bù fā zhǎn yí gè bié rén chuán chéng shén me\ndì sān bù gāo cháo guó rén shén me fǎn yìng shèn zhì chuán dào le nǎ lǐ\ndì sù bù jié jú sòng jūn rú hé zuò zuì zhōng zhēn xiàng rú hé",
        sEn: "Step 1: The Starting Point—What did Ding originally say?\nStep 2: The Development—What did a certain individual pass it on as?\nStep 3: The Climax—How did the public react, and where did it eventually reach?\nStep 4: The Outcome—What did the Lord do, and what was the ultimate truth?",
