    ...
    lines: [
        {
            words: [
                ...
                { text: "盖汲", pinyin: "gài jí", zh: "指翻土浇田和打水。盖：同‘溉’，灌溉、浇地；汲：从井里打水。", en: "to irrigate and fetch water." },
                { text: "，", isPunctuation: true },
        ...
        },
        {
            words: [
                ...
                { text: "“", isPunctuation: true },
                { text: "吾", pinyin: "wú", zh: "我，或者我们（指我丁家）。", en: "We" },
        ...
        },
        {
            words: [
                ...
                { text: "得", pinyin: "dé", zh: "误传为‘获得’或‘挖出’了一个人。", en: "and found" },
        ...
        },
        {
            words: [
                ...
                { text: "一人之使", pinyin: "dé yī rén zhī shǐ", zh: "得到一个人的劳动力（供使唤）。使：名词，劳力、使唤、佣工；之：结构助词‘的’。", en: "the labor of one person," },
                { text: "，", isPunctuation: true },
        ...
        {
            words: [
                { text: "求闻", pinyin: "qiú wén", zh: "寻觅、探求听到的传闻消息。求：寻求、探求；闻：听到的传闻。", en: "Seeking news" },
                { text: "之", pinyin: "zhī", zh: "音节助词，无实际意义。", en: "" },
                { text: "若此", pinyin: "ruò cǐ", zh: "像这样（盲目轻信、以讹传讹）。若：像；此：这样。", en: "like this," },
                { text: "，", isPunctuation: true },
